        ...
        >
          <Card className="p-6 bg-[#1a2421] border-[#3a4441]">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-[#e3b261] mb-2">Create Account</h1>
              <p className="text-gray-400">Join us for amazing safari adventures</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-center text-gray-400">
                ...
                <Link href="/login" className="text-[#e3b261] hover:underline">
                  Sign In
                </Link>
              </p>
            </form>
