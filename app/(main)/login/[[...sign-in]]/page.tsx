      ...
      >
        <div className="text-center mb-8">
          <Link href="/" className="inline-block mb-8 transform hover:scale-105 transition-transform">
            <div className="relative h-16 w-64 mx-auto ml-0">
              <Image
                src="/logo.png"
          ...
          >
            <h1 className="text-4xl font-bold text-[#e3b261] mb-3">Welcome Back</h1>
            <p className="text-gray-400 text-lg">Sign in to your account to continue your adventure</p>
          </motion.div>
        </div>
        ...
        >
          <p className="text-gray-400 text-lg">
            ...
            <Link href="/signup" className="text-[#e3b261] hover:text-[#c49a51] font-medium transition-colors">
              Sign up
            </Link>
          </p>
        </motion.div>
